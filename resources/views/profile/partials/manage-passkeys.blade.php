<section>
    ...
    <form x-data='registerPasskey' x-on:submit.prevent='register($el)' name="createPasskey" method="post" action="{{ route('passkeys.store') }}"
            ...
            @foreach ($user->passkeys as $passkey)
                <li class="flex items-center justify-between px-2 py-2">
                    <div class="flex flex-col">
                        ...
                        <span class="text-sm font-thin text-gray-600">Added
